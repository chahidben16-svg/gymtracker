...
const EXERCISES = {
  borst: [
    ...
    { id: "dbbench",        name: "Dumbbell Bench Press", unit: "kg", defaultReps: 10, defaultWeight: 30 },
    { id: "inclinebar",     name: "Incline Barbell Press",unit: "kg", defaultReps: 8,  defaultWeight: 60 },
    { id: "lowtohigh",      name: "Low to High Cable",    unit: "kg", defaultReps: 12, defaultWeight: 12 },
    { id: "cablecross",     name: "Cable Crossover",      unit: "kg", defaultReps: 12, defaultWeight: 15 },
  ],
  rug: [
  ...
  benen: [
    ...
    { id: "hacksquat",   name: "Hack Squat",           unit: "kg", defaultReps: 10, defaultWeight: 80  },
    { id: "legext",      name: "Leg Extension",        unit: "kg", defaultReps: 12, defaultWeight: 50  },
    { id: "seatedcalf",  name: "Seated Calf Raise",    unit: "kg", defaultReps: 15, defaultWeight: 30  },
    { id: "hipthrust",   name: "Hip Thrust",           unit: "kg", defaultReps: 10, defaultWeight: 80  },
  ...
  biceps: [
    ...
    { id: "cablecurl",  name: "Cable Curl",            unit: "kg", defaultReps: 12, defaultWeight: 15 },
    { id: "ezcurl",     name: "EZ-Bar Curl",           unit: "kg", defaultReps: 10, defaultWeight: 25 },
    { id: "spidercurl", name: "Spider Curl",           unit: "kg", defaultReps: 10, defaultWeight: 12 },
    { id: "inclinecurl",name: "Incline Dumbbell Curl", unit: "kg", defaultReps: 10, defaultWeight: 10 },
  ],
  triceps: [
    ...
    { id: "cgbench",         name: "Close Grip Bench Press", unit: "kg", defaultReps: 10, defaultWeight: 50 },
    { id: "tricdips",        name: "Tricep Dips",            unit: "bw", defaultReps: 12, defaultWeight: 0  },
    { id: "skullcrusher",    name: "EZ-Bar Skull Crusher",   unit: "kg", defaultReps: 10, defaultWeight: 20 },
    { id: "cableoverhead",   name: "Cable Overhead Ext.",    unit: "kg", defaultReps: 12, defaultWeight: 15 },
    { id: "kickback",        name: "Tricep Kickback",        unit: "kg", defaultReps: 12, defaultWeight: 10 },
  ],
  schouders: [
    ...
    { id: "barbohp",        name: "Barbell Overhead Press",  unit: "kg", defaultReps: 8,  defaultWeight: 40 },
    { id: "dbohp",          name: "Dumbbell Overhead Press", unit: "kg", defaultReps: 10, defaultWeight: 20 },
    { id: "facepull",       name: "Face Pull",               unit: "kg", defaultReps: 15, defaultWeight: 20 },
    { id: "reversefly",     name: "Reverse Fly",             unit: "kg", defaultReps: 12, defaultWeight: 8  },
    { id: "frontraise",     name: "Front Raise",             unit: "kg", defaultReps: 12, defaultWeight: 8  },
  ],
  core: [
    ...
    { id: "wplank",     name: "Weighted Plank",         unit: "sec", defaultReps: 45, defaultWeight: 0  },
  ],
};
